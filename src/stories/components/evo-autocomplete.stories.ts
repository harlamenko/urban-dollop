...
import {EvoAlertModule, EvoButtonModule, switchQueryToList} from '@ud/ui-kit';
...
<div class="story-container">
    ...
    props: {
        ...
        cities$: switchQueryToList(searchCity$, function (query) {
            ...
            this.isSearch = true;
            return from(
                fetch(`https://market-test.ud.ru/api/dadata/public/suggestions/api/4_1/rs/suggest/address`, {
                    method: 'POST',
                    headers,
...
<div class="story-container">
    ...
    props: {
        ...
        parties$: switchQueryToList(searchParty$, function (query) {
            ...
            this.isSearch = true;
            return from(
                fetch(`https://market-test.ud.ru/api/dadata/public/suggestions/api/4_1/rs/suggest/party`, {
                    method: 'POST',
                    headers,
                    body: JSON.stringify({query: query, count: 6}),
                }),
...
<div class="story-container">
    ...
    props: {
        ...
        fios$: switchQueryToList(searchFio$, function (query) {
            ...
            this.isSearch = true;
            return from(
                fetch(`https://market-test.ud.ru/api/dadata/public/suggestions/api/4_1/rs/suggest/fio`, {
                    method: 'POST',
                    headers,
                    body: JSON.stringify({query: query, count: 6}),
                }),
